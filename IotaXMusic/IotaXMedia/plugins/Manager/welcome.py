...
BG_PATH = "IotaXMedia/assets/iota/welcome.png"
FALLBACK_PIC = "IotaXMedia/assets/upic.png"
FONT_PATH = "IotaXMedia/assets/iota/Arimo.ttf"
...
async def welcome(client, update: ChatMemberUpdated):
    ...
    async def cleanup(path):
        if path and os.path.exists(path) and not os.path.abspath(path).startswith(os.path.abspath("IotaXMedia/assets")):
            try:
                os.remove(path)
            except:
                pass
