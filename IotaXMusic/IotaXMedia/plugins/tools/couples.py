...
from IotaXMedia.core.dir import COUPLE_DIR
from IotaXMedia.mongo.couples_db import get_couple, save_couple
...
async def generate_image(chat_id: int, uid1: int, uid2: int, date: str) -> str:
    base = Image.open(ASSETS / "iota/couple.png").convert("RGBA")
